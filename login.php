...
include_once "layout_head.php";
            ...
            echo "<img class='mb-4 logo' src='ArtImages/ArtCritiqLogo.png' align='middle'>";
            echo "<div class='logstart'>";
                echo "<form class='form-signin' action='" . htmlspecialchars($_SERVER["PHP_SELF"]) . "' method='post'>";
                    echo "<h1 class='h3 mb-3 font-weight-normal' style='text-align:left;color:yellow;'>Please Sign in</h1>";
                    echo "<input type='email' name='email' class='form-control' placeholder='Email' required autofocus />";
                    echo "<input type='password' name='password' class='form-control' placeholder='Password' required />";
                    echo "<p id='logLead' class='lead'>Don't have an account? </p><a href='{$home_url}register.php'>Create account.</a>";
